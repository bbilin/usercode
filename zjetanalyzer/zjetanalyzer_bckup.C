...
//myTree.Add("/tmp/bbilin/2011B_10_04_2012.root");
//TFile *theFile = new TFile("10_04_2011B_44X.root","RECREATE");
//myTree.Add("/tmp/bbilin/2011A_10_04_2012.root");
//TFile *theFile = new TFile("10_04_2011A_44X.root","RECREATE");
//TFile *theFile = new TFile("17_04_2011AB_44X.root","RECREATE");
...
//TFile *theFile = new TFile("27_03_bg_WW.root","RECREATE");

//myTree.Add("/tmp/bbilin/ZZ_bg_12_03_2012.root");
//TFile *theFile = new TFile("27_03_bg_ZZ.root","RECREATE");

//myTree.Add("/tmp/bbilin/WZ_bg_12_03_2012.root");
//TFile *theFile = new TFile("27_03_bg_WZ.root","RECREATE");

//myTree.Add("/tmp/bbilin/Ztautau_bg_12_03_2012.root");
//TFile *theFile = new TFile("27_03_bg_Ztautau.root","RECREATE");

//myTree.Add("/tmp/bbilin/Wjets_bg_12_03_2012.root");
//TFile *theFile = new TFile("27_03_bg_Wjets.root","RECREATE");

//myTree.Add("/tmp/bbilin/tt_bg_12_03_2012.root");
//TFile *theFile = new TFile("27_03_bg_tt.root","RECREATE");
...
//  int hlt_trigger_fired;
  ...
  float ElecPt[50], ElecEta[50], ElecPhi[50],ElecPx[50], ElecPy[50], ElecPz[50], ElecM[50], ElecE[50], Elecdr03TkSumPt[50], Elecdr03EcalRecHitSumEt[50], Elecdr03HcalTowerSumEt[50], ElecscSigmaIEtaIEta[50], ElecdeltaPhiSuperClusterTrackAtVtx[50], ElecdeltaEtaSuperClusterTrackAtVtx[50], ElechadronicOverEm[50],ElecgsfTrack_numberOfLostHits[50],ElecGsfTrk_d0[50],ElecDcotTheta[50],hfelec_Pt[50],hfelec_Px[50],hfelec_Py[50],hfelec_Pz[50],hfelec_Phi[50],hfelec_E[50],hfelec_M[50],hfelec_Eta[50], hfelec_L9[50], hfelec_S9[50], hfelec_L25[50], hfelec_L1[50], hhfclustereta[50], hhfclusterphi[50],hfelec_charge[50];
...
if(
egsfTrack_numberOfLostHits[ii]<1 && ( fabs(eGsfTrk_d0[ii])>0.02 && fabs(eDcotTheta[ii])>0.02 ) &&  ePt[ii] > 20.  && fabs(eEta[ii]) <2.4 && (fabs(eEta[ii]) <1.4442 || fabs(eEta[ii])>1.560) &&
...
if(
egsfTrack_numberOfLostHits[ii]<2 && ( fabs(eGsfTrk_d0[ii])>0.02 && fabs(eDcotTheta[ii])>0.02 ) &&  ePt[ii] > 20.  && fabs(eEta[ii]) <2.4 && (fabs(eEta[ii]) <1.4442 || fabs(eEta[ii])>1.560) &&

((eIsEB[ii] ==1 && eIsEB[ii]==1 && edr03TkSumPt[ii]/ePt[ii]<0.15 && edr03EcalRecHitSumEt[ii]/ePt[ii]<2. && edr03HcalTowerSumEt[ii]/ePt[ii]<0.12 && escSigmaIEtaIEta[ii]<0.01 && fabs(edeltaPhiSuperClusterTrackAtVtx[ii])<0.8 && fabs(edeltaEtaSuperClusterTrackAtVtx[ii])<0.007 && ehadronicOverEm[ii]<0.15
) ||
(eIsEE[ii] ==1 && edr03TkSumPt[ii]/ePt[ii]<0.08 && edr03EcalRecHitSumEt[ii]/ePt[ii]<0.06 && edr03HcalTowerSumEt[ii]/ePt[ii]<0.05 && escSigmaIEtaIEta[ii]<0.03 && fabs(edeltaPhiSuperClusterTrackAtVtx[ii])<0.7 && fabs(edeltaEtaSuperClusterTrackAtVtx[ii])<0.01 && ehadronicOverEm[ii]<0.07 ))

){e_cut_fired_l[ii]=1;
elec_ind_l[nelec_fire_cut_l]=ii;
nelec_fire_cut_l++;
}
//
...
//cout<<nelec_fire_cut_l<<endl;
//cout<<nelec_fire_cut_l<<"   "<<elec_ind_l[nelec_fire_cut_l-1]<<endl;

//if(nelec_fire_cut_l>2)cout<<"more than 2 loose id elec in 1 evt"<<endl;
//cout<<nelec_fire_cut<<endl;
int hf_cut_fired[50] = {};
double hfePt[50]={},hfePx[50]={},hfePy[50]={},hfePz[50]={},hfeE[50]={}, hfeM[50]={}, hfeEta[50]={},hfePhi[50]={},  hfeL9[50]={},  hfeS9[50]={},  hfeL25[50]={},  hfeL1[50]={},  hfclustereta[50]={},  hfclusterphi[50]={},hfeCharge[50];
//
for(int ii = 0 ; ii < HFElecindex ; ii++)
{
hfePt[ii]=hfelec_Pt[ii];
hfePx[ii]=hfelec_Px[ii];
hfePy[ii]=hfelec_Py[ii];
hfePz[ii]=hfelec_Pz[ii];
hfeE[ii]=hfelec_E[ii];
hfeM[ii]=hfelec_M[ii];
hfeCharge[ii]=hfelec_charge[ii];
...
hfclustereta[ii]= hhfclustereta[ii];
hfclusterphi[ii]=hhfclusterphi[ii];
double cut2 = (hfeL1[ii]/hfeL9[ii]) -(1.125 * (hfeS9[ii]/hfeL9[ii]));
if (
(hfeL9[ii]/hfeL25[ii]>0.96)&& 	
(cut2>0.4)&&hfePt[ii]>20.
) {
hf_cut_fired[ii]=1;
...
//if(nelec_hf_fire_cut>1)cout<<"DANGER"<<endl;
