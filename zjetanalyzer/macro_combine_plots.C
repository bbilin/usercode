...
file[0] = TFile::Open("10_08_data.root");

file[1] = TFile::Open("10_08_mc.root");

file[2] = TFile::Open("10_08_bg_ztautau.root");

file[3] = TFile::Open("10_08_bg_tt.root");

file[4] = TFile::Open("10_08_bg_wjets.root");

file[5] = TFile::Open("10_08_ww.root");
file[6] = TFile::Open("10_08_wz.root");
file[7] = TFile::Open("10_08_zz.root");

file[8] = TFile::Open("10_08_mc_low.root");

TH1F *h_[500][500];
int numberoffiles = 9;
int number_of_histos = 167;
...
h_[ii][1] =(TH1F*) file[ii] ->Get("h_elec_mva_nl");
...
h_[ii][33] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_hf_0");
...
h_[ii][37] =(TH1F*) file[ii] ->Get("h_jet_eta_all0");
...
h_[ii][64] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_hf_1");
...
h_[ii][68] =(TH1F*) file[ii] ->Get("h_jet_eta_all1");
...
h_[ii][95] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_hf_4");
...
h_[ii][99] =(TH1F*) file[ii] ->Get("h_jet_eta_all4");
...
h_[ii][100] =(TH1F*) file[ii] ->Get("h_jet_pt_hbhe_4");
h_[ii][100]->GetXaxis()->SetTitle("Jet pt for leading jet in HBHE  of MVA(e1)>0.5 MVA(e2)<0.5");
h_[ii][100]->GetYaxis()->SetTitle("Entries");
h_[ii][101] =(TH1F*) file[ii] ->Get("h_jet_eta_hbhe4");
h_[ii][101]->GetXaxis()->SetTitle("Jet #eta for leading jet in HBHE  of MVA(e1)>0.5 MVA(e2)<0.5");
h_[ii][101]->GetYaxis()->SetTitle("Entries");
h_[ii][102] =(TH1F*) file[ii] ->Get("h_jet_pt_hf_4");
h_[ii][102]->GetXaxis()->SetTitle("Jet pt for leading jet in HF  of MVA(e1)>0.5 MVA(e2)<0.5");
h_[ii][102]->GetYaxis()->SetTitle("Entries");
h_[ii][103] =(TH1F*) file[ii] ->Get("h_jet_eta_hf4");
h_[ii][103]->GetXaxis()->SetTitle("Jet #eta for leading jet in HF  of MVA(e1)>0.5 MVA(e2)<0.5");
h_[ii][103]->GetYaxis()->SetTitle("Entries");

h_[ii][104] =(TH1F*) file[ii] ->Get("h_elec_pt_5");
h_[ii][104]->GetXaxis()->SetTitle("Leading Electron P_{T} of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][104]->GetYaxis()->SetTitle("Entries");
h_[ii][105] =(TH1F*) file[ii] ->Get("h_elec_eta_5");
h_[ii][105]->GetXaxis()->SetTitle("Leading Electron #eta of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][105]->GetYaxis()->SetTitle("Entries");
h_[ii][106] =(TH1F*) file[ii] ->Get("h_numberofPFjets_5");
h_[ii][106]->GetXaxis()->SetTitle("Exclusive Jet Multiplicity of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][106]->GetYaxis()->SetTitle("Entries");
h_[ii][107] =(TH1F*) file[ii] ->Get("h_numberofPFjets_hbhe_5");
h_[ii][107]->GetXaxis()->SetTitle("Exclusive Jet Multiplicity in HBHE of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][107]->GetYaxis()->SetTitle("Entries");
h_[ii][108] =(TH1F*) file[ii] ->Get("h_numberofPFjets_hf_5");
h_[ii][108]->GetXaxis()->SetTitle("Exclusive Jet Multiplicity in HF of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][108]->GetYaxis()->SetTitle("Entries");
h_[ii][109] =(TH1F*) file[ii] ->Get("h_mz_5.root");
h_[ii][109]->GetXaxis()->SetTitle("Z Mass of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][109]->GetYaxis()->SetTitle("Entries");
h_[ii][110] =(TH1F*) file[ii] ->Get("h_mz_1j_all_5");
h_[ii][110]->GetXaxis()->SetTitle("Z mass for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][110]->GetYaxis()->SetTitle("Entries");
h_[ii][111] =(TH1F*) file[ii] ->Get("h_mz_1j_c_5");
h_[ii][111]->GetXaxis()->SetTitle("Z mass for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][111]->GetYaxis()->SetTitle("Entries");
h_[ii][112] =(TH1F*) file[ii] ->Get("h_mz_1j_hf_5");
h_[ii][112]->GetXaxis()->SetTitle("Z mass for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][112]->GetYaxis()->SetTitle("Entries");
h_[ii][113] =(TH1F*) file[ii] ->Get("h_dielec_PT_5");
h_[ii][113]->GetXaxis()->SetTitle("Z P_{T}  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][113]->GetYaxis()->SetTitle("Entries");
h_[ii][114] =(TH1F*) file[ii] ->Get("h_dielec_PT_1j_all_5");
h_[ii][114]->GetXaxis()->SetTitle("Z P_{T} for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][114]->GetYaxis()->SetTitle("Entries");
h_[ii][115] =(TH1F*) file[ii] ->Get("h_dielec_PT_1j_c_5");
h_[ii][115]->GetXaxis()->SetTitle("Z P_{T} for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][115]->GetYaxis()->SetTitle("Entries");
h_[ii][116] =(TH1F*) file[ii] ->Get("h_dielec_PT_1j_hf_5");
h_[ii][116]->GetXaxis()->SetTitle("Z P_{T} for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][116]->GetYaxis()->SetTitle("Entries");
h_[ii][117] =(TH1F*) file[ii] ->Get("h_dielecphi_5");
h_[ii][117]->GetXaxis()->SetTitle("Z #phi of MVA(e1)<0.5 MVA(e2)>0.5 ");
h_[ii][117]->GetYaxis()->SetTitle("Entries");
h_[ii][118] =(TH1F*) file[ii] ->Get("h_dielecphi_1j_all_5");
h_[ii][118]->GetXaxis()->SetTitle("Z #phi for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][118]->GetYaxis()->SetTitle("Entries");
h_[ii][119] =(TH1F*) file[ii] ->Get("h_dielecphi_1j_c_5");
h_[ii][119]->GetXaxis()->SetTitle("Z #phi for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][119]->GetYaxis()->SetTitle("Entries");
h_[ii][120] =(TH1F*) file[ii] ->Get("h_dielecphi_1j_hf_5");
h_[ii][120]->GetXaxis()->SetTitle("Z #phi for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][120]->GetYaxis()->SetTitle("Entries");
h_[ii][121] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_5");
h_[ii][121]->GetXaxis()->SetTitle("Z Y of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][121]->GetYaxis()->SetTitle("Entries");
h_[ii][122] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_1j_all_5");
h_[ii][122]->GetXaxis()->SetTitle("Z Y for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][122]->GetYaxis()->SetTitle("Entries");
h_[ii][123] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_1j_c_5");
h_[ii][123]->GetXaxis()->SetTitle("Z Y for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][123]->GetYaxis()->SetTitle("Entries");
h_[ii][124] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_1j_hf_5");
h_[ii][124]->GetXaxis()->SetTitle("Z Y for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][124]->GetYaxis()->SetTitle("Entries");
h_[ii][125] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_5");
h_[ii][125]->GetXaxis()->SetTitle("#DeltaR(e,j) for central electrons #& central jets of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][125]->GetYaxis()->SetTitle("Entries");
h_[ii][126] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_hf_5");
h_[ii][126]->GetXaxis()->SetTitle("#DeltaR(e,j)for HF electrons #& HF jets of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][126]->GetYaxis()->SetTitle("Entries");
h_[ii][127] =(TH1F*) file[ii] ->Get("h_no_good_vtx_zevents_5");
h_[ii][127]->GetXaxis()->SetTitle("# of good vertices of Z events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][127]->GetYaxis()->SetTitle("Entries");
h_[ii][128] =(TH1F*) file[ii] ->Get("h_mz_same_sign_5");
h_[ii][128]->GetXaxis()->SetTitle("same sign electron invariant mass of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][128]->GetYaxis()->SetTitle("Entries");
h_[ii][129] =(TH1F*) file[ii] ->Get("h_jet_pt_all_5");
h_[ii][129]->GetXaxis()->SetTitle("Jet pt for leading jet in all detector of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][129]->GetYaxis()->SetTitle("Entries");
h_[ii][130] =(TH1F*) file[ii] ->Get("h_jet_eta_all5");
h_[ii][130]->GetXaxis()->SetTitle("Jet #eta for leading jet in all detector of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][130]->GetYaxis()->SetTitle("Entries");
h_[ii][131] =(TH1F*) file[ii] ->Get("h_jet_pt_hbhe_5");
h_[ii][131]->GetXaxis()->SetTitle("Jet pt for leading jet in HBHE  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][131]->GetYaxis()->SetTitle("Entries");
h_[ii][132] =(TH1F*) file[ii] ->Get("h_jet_eta_hbhe5");
h_[ii][132]->GetXaxis()->SetTitle("Jet #eta for leading jet in HBHE  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][132]->GetYaxis()->SetTitle("Entries");
h_[ii][133] =(TH1F*) file[ii] ->Get("h_jet_pt_hf_5");
h_[ii][133]->GetXaxis()->SetTitle("Jet pt for leading jet in HF  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][133]->GetYaxis()->SetTitle("Entries");
h_[ii][134] =(TH1F*) file[ii] ->Get("h_jet_eta_hf5");
h_[ii][134]->GetXaxis()->SetTitle("Jet #eta for leading jet in HF  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][134]->GetYaxis()->SetTitle("Entries");
h_[ii][135] =(TH1F*) file[ii] ->Get("h_jet_eta_hf5");
h_[ii][135]->GetXaxis()->SetTitle("Jet #eta for leading jet in HF  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][135]->GetYaxis()->SetTitle("Entries");

h_[ii][136] =(TH1F*) file[ii] ->Get("h_elec_pt_6");
h_[ii][136]->GetXaxis()->SetTitle("Leading Electron P_{T} of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][136]->GetYaxis()->SetTitle("Entries");
h_[ii][137] =(TH1F*) file[ii] ->Get("h_elec_eta_6");
h_[ii][137]->GetXaxis()->SetTitle("Leading Electron #eta of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][137]->GetYaxis()->SetTitle("Entries");
h_[ii][138] =(TH1F*) file[ii] ->Get("h_numberofPFjets_6");
h_[ii][138]->GetXaxis()->SetTitle("Exclusive Jet Multiplicity of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][138]->GetYaxis()->SetTitle("Entries");
h_[ii][139] =(TH1F*) file[ii] ->Get("h_numberofPFjets_hbhe_6");
h_[ii][139]->GetXaxis()->SetTitle("Exclusive Jet Multiplicity in HBHE of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][139]->GetYaxis()->SetTitle("Entries");
h_[ii][140] =(TH1F*) file[ii] ->Get("h_numberofPFjets_hf_6");
h_[ii][140]->GetXaxis()->SetTitle("Exclusive Jet Multiplicity in HF of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][140]->GetYaxis()->SetTitle("Entries");
h_[ii][141] =(TH1F*) file[ii] ->Get("h_mz_6.root");
h_[ii][141]->GetXaxis()->SetTitle("Z Mass of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][141]->GetYaxis()->SetTitle("Entries");
h_[ii][142] =(TH1F*) file[ii] ->Get("h_mz_1j_all_6");
h_[ii][142]->GetXaxis()->SetTitle("Z mass for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][142]->GetYaxis()->SetTitle("Entries");
h_[ii][143] =(TH1F*) file[ii] ->Get("h_mz_1j_c_6");
h_[ii][143]->GetXaxis()->SetTitle("Z mass for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][143]->GetYaxis()->SetTitle("Entries");
h_[ii][144] =(TH1F*) file[ii] ->Get("h_mz_1j_hf_6");
h_[ii][144]->GetXaxis()->SetTitle("Z mass for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][144]->GetYaxis()->SetTitle("Entries");
h_[ii][145] =(TH1F*) file[ii] ->Get("h_dielec_PT_6");
h_[ii][145]->GetXaxis()->SetTitle("Z P_{T}  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][145]->GetYaxis()->SetTitle("Entries");
h_[ii][146] =(TH1F*) file[ii] ->Get("h_dielec_PT_1j_all_6");
h_[ii][146]->GetXaxis()->SetTitle("Z P_{T} for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][146]->GetYaxis()->SetTitle("Entries");
h_[ii][147] =(TH1F*) file[ii] ->Get("h_dielec_PT_1j_c_6");
h_[ii][147]->GetXaxis()->SetTitle("Z P_{T} for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][147]->GetYaxis()->SetTitle("Entries");
h_[ii][148] =(TH1F*) file[ii] ->Get("h_dielec_PT_1j_hf_6");
h_[ii][148]->GetXaxis()->SetTitle("Z P_{T} for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][148]->GetYaxis()->SetTitle("Entries");
h_[ii][149] =(TH1F*) file[ii] ->Get("h_dielecphi_6");
h_[ii][149]->GetXaxis()->SetTitle("Z #phi of MVA(e1)<0.5 MVA(e2)>0.5 ");
h_[ii][149]->GetYaxis()->SetTitle("Entries");
h_[ii][150] =(TH1F*) file[ii] ->Get("h_dielecphi_1j_all_6");
h_[ii][150]->GetXaxis()->SetTitle("Z #phi for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][150]->GetYaxis()->SetTitle("Entries");
h_[ii][151] =(TH1F*) file[ii] ->Get("h_dielecphi_1j_c_6");
h_[ii][151]->GetXaxis()->SetTitle("Z #phi for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][151]->GetYaxis()->SetTitle("Entries");
h_[ii][152] =(TH1F*) file[ii] ->Get("h_dielecphi_1j_hf_6");
h_[ii][152]->GetXaxis()->SetTitle("Z #phi for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][152]->GetYaxis()->SetTitle("Entries");
h_[ii][153] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_6");
h_[ii][153]->GetXaxis()->SetTitle("Z Y of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][153]->GetYaxis()->SetTitle("Entries");
h_[ii][154] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_1j_all_6");
h_[ii][154]->GetXaxis()->SetTitle("Z Y for excl. Z+1 jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][154]->GetYaxis()->SetTitle("Entries");
h_[ii][155] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_1j_c_6");
h_[ii][155]->GetXaxis()->SetTitle("Z Y for excl. Z+1 central jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][155]->GetYaxis()->SetTitle("Entries");
h_[ii][156] =(TH1F*) file[ii] ->Get("h_dielec_rapidity_1j_hf_6");
h_[ii][156]->GetXaxis()->SetTitle("Z Y for excl. Z+1 HF jet events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][156]->GetYaxis()->SetTitle("Entries");
h_[ii][157] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_6");
h_[ii][157]->GetXaxis()->SetTitle("#DeltaR(e,j) for central electrons #& central jets of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][157]->GetYaxis()->SetTitle("Entries");
h_[ii][158] =(TH1F*) file[ii] ->Get("h_deltar_elec_PFjet_hf_6");
h_[ii][158]->GetXaxis()->SetTitle("#DeltaR(e,j)for HF electrons #& HF jets of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][158]->GetYaxis()->SetTitle("Entries");
h_[ii][159] =(TH1F*) file[ii] ->Get("h_no_good_vtx_zevents_6");
h_[ii][159]->GetXaxis()->SetTitle("# of good vertices of Z events of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][159]->GetYaxis()->SetTitle("Entries");
h_[ii][160] =(TH1F*) file[ii] ->Get("h_mz_same_sign_6");
h_[ii][160]->GetXaxis()->SetTitle("same sign electron invariant mass of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][160]->GetYaxis()->SetTitle("Entries");
h_[ii][161] =(TH1F*) file[ii] ->Get("h_jet_pt_all_6");
h_[ii][161]->GetXaxis()->SetTitle("Jet pt for leading jet in all detector of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][161]->GetYaxis()->SetTitle("Entries");
h_[ii][162] =(TH1F*) file[ii] ->Get("h_jet_eta_all6");
h_[ii][162]->GetXaxis()->SetTitle("Jet #eta for leading jet in all detector of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][162]->GetYaxis()->SetTitle("Entries");
h_[ii][163] =(TH1F*) file[ii] ->Get("h_jet_pt_hbhe_6");
h_[ii][163]->GetXaxis()->SetTitle("Jet pt for leading jet in HBHE  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][163]->GetYaxis()->SetTitle("Entries");
h_[ii][164] =(TH1F*) file[ii] ->Get("h_jet_eta_hbhe6");
h_[ii][164]->GetXaxis()->SetTitle("Jet #eta for leading jet in HBHE  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][164]->GetYaxis()->SetTitle("Entries");
h_[ii][165] =(TH1F*) file[ii] ->Get("h_jet_pt_hf_6");
h_[ii][165]->GetXaxis()->SetTitle("Jet pt for leading jet in HF  of MVA(e1)<0.5 MVA(e2)>0.5");
h_[ii][165]->GetYaxis()->SetTitle("Entries");
h_[ii][166] =(TH1F*) file[ii] ->Get("h_jet_eta_hf6");
h_[ii][166]->GetXaxis()->SetTitle("Jet #eta for leading jet in HF  of MVA(e1)<0.5 MVA(e2)>0.5");
...
if(ii>1 && ii<11)integral_norm = true;
if(ii==35) same_sign_0=true; if(ii==66) same_sign_1=true; if(ii==97) same_sign_4=true; if(ii==128) same_sign_5=true;
...
if(same_sign_5){
qcd_bckg_5 = (TH1F*)h_[0][ii]->Clone();
qcd_bckg_5->Add(h_[1][ii],-1);
}
...
c_qcd_5->cd();
qcd_bckg_5->GetXaxis()->SetTitle("same-sign ee inv.M. Data-(MC+BG) of MVA(e1)<0.5 MVA(e2)>0.5");
qcd_bckg_5->GetXaxis()->SetTitleSize(0.03);
qcd_bckg_5->GetYaxis()->SetTitle("Entries");
qcd_bckg_5->Draw("E1");
c_qcd_5->Print("histo_z_plot/qcd_bckground_5.root");
c_qcd_5->Print("histo_z_plot/qcd_bckground_5.pdf");
